    ...
    <div class="uk-width-1-3@s">
        <div class="uk-card uk-card-default uk-card-body uk-margin">
            ...
            <div class="uk-card-body">
                ...
                <h3 class="uk-text-meta uk-text-uppercase uk-margin-remove-bottom uk-margin-remove-top" id='temp-text'></h3>
            </div>
        ...
        <div class="uk-card uk-card-default uk-card-body uk-margin">
            <div class="uk-card-header">
                <div class="uk-grid-small uk-flex-middle" uk-grid>
                    ...
                    <div class="uk-width-expand">
                    <h3 class="uk-text-meta uk-text-uppercase uk-margin-remove-bottom uk-margin-remove-top"><?php echo $_SESSION['usuario']['email']?></h3>
                    </div>
                </div>
            </div>
            <div class="uk-card-body">
                <h3 class="uk-text-meta uk-text-uppercase uk-margin-remove-bottom uk-margin-remove-top">Miembro desde : <?php echo date_format($date,'l jS F Y')?></h3>
                <h3 class="uk-text-meta uk-text-uppercase uk-margin-remove-bottom uk-margin-remove-top">Nombre: <?php echo $_SESSION['usuario']['name']?></h3>
                <h3 class="uk-text-meta uk-text-uppercase uk-margin-remove-bottom uk-margin-remove-top">Tipo de Miembro: <?php echo $_SESSION['usuario']['member_type']?></h3>
            </div>
            <div class="uk-card-footer">
                <form action="">
